# CSCI 381
# Summer 2022
# Homework Chapter 8 - 8.25
# Gabriel Rubio Alvarado

"""Exercise 8.25
(Project: State of the Union Speeches) All U.S. Presidents’ State of the Union
speeches are available online. Copy and paste one into a large multiline string, then display
statistics, including the total word count, the total character count, the average word
length, the average sentence length, a word distribution of all words, a word distribution
