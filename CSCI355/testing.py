...
def main():
    ...
    heading = create_element(TAG_H1, "Christian's United States")
    # link_attributes = 'rel="stylesheet" herf="mystyle1.css"'
    link_attributes = 'rel="stylesheet" href = "mystyle1.css"'
    ...
    write_file("states1.html", message)
    open_file_in_browser("states1.html")
